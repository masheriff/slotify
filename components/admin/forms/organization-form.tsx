...
export function OrganizationForm({
  ...
  useEffect(() => {
    setIsSlugAutoGenerated(mode === "create");
  }, [mode, organizationId]);
  ...
  useEffect(() => {
    if (mode === "create" && name && isSlugAutoGenerated) {
      const newSlug = generateSlug(name);
      form.setValue("slug", newSlug, { shouldValidate: true });
    }
  }, [name, mode, form, generateSlug, isSlugAutoGenerated]);
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormControl>
                      <div className="relative">
                        <Input
                          ...
                          {...field}
                          onChange={(e) => {
                            setIsSlugAutoGenerated(false); // User manually edited
                            field.onChange(e);
                          }}
                          className={cn(
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Healthcare compliance and data protection settings
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="Jane Smith, Chief Privacy Officer"
                        {...field}
                      />
                    </FormControl>
                    <FormDescription>
                      Name and title of the designated HIPAA compliance officer
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
